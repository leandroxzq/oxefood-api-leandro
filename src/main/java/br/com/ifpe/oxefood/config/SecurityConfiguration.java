    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
               ...
               .requestMatchers(HttpMethod.GET, "/api/cliente", "/api/cliente/", "/api/cliente/*").hasAnyAuthority(
                   Perfil.ROLE_CLIENTE,
               ...
               .requestMatchers(HttpMethod.GET, "/api/produto", "/api/produto/", "/api/produto/*").hasAnyAuthority(
                   Perfil.ROLE_CLIENTE,
                   Perfil.ROLE_FUNCIONARIO_ADMIN,
               ...
               .requestMatchers(HttpMethod.POST, "/api/produto/filtrar").hasAnyAuthority(
                   Perfil.ROLE_CLIENTE,
                   Perfil.ROLE_FUNCIONARIO_ADMIN,
                   Perfil.ROLE_FUNCIONARIO_USER)
